<?php
# Created By Dr YawYaw Strong and protected by password ...
// Add login/password pairs below, like described above
// NOTE: all rows except last must have comma "," at the end of line
$SkandareProtect = array(
  '' => 'skanpass' /// Pw Default = skanpass
);
...
<head>
  <meta charset="utf-8">
<!-- Page title -->
<title> | Log In | P0wer Ma!ler Inb0x By Dr YawYaw</title>
...
<span aria-hidden="true" class="octicon octicon-link"></span></a>Welcome To P0wer Ma!ler Inb0x <code style="font-size:12px;color:#0bc4d1;">v2.1 </code> </h1>
<p style="font-size:13px;color:#ffffff;">
 <code style="font-size:12px;color:#0bc4d1;"> Function P0wer Ma!ler Inb0x v2.1</code>
...
<div>
	 ...
	 <p></p><p></p>
<p style="font-size:12px;color:#ffffff;">&copy; 2017 CODED BY <? echo $MyRight ;?> | <a href="https://Dr-yawyaw.com" target="black"> DOWNLOAD SCRIPT </a> |</p>
<p></p><p></p>
<br> <br>
</div>
</div>
...
if (isset($_POST['access_password'])) {
  ...
  if (!USE_USERNAME && !in_array($pass, $SkandareProtect)
  || (USE_USERNAME && ( !array_key_exists($login, $SkandareProtect) || $SkandareProtect[$login] != $pass ) ) 
  ) {
  ...
  $found = false;
  foreach($SkandareProtect as $key=>$val) {
...
<head>
  <meta charset="utf-8">
<!-- Page title -->
<title>P0wer Ma!ler Inb0x By Dr YawYaw</title>
<!-- Gotsta have that favicon-->
<link rel="icon" type="image/png" href="https://cdn0.iconfinder.com/data/icons/kameleon-free-pack-rounded/110/Paper-Plane-512.png" />
<link rel="shortcut icon" type="image/x-icon" href="https://cdn0.iconfinder.com/data/icons/kameleon-free-pack-rounded/110/Paper-Plane-512.png" />
<!-- CRACKER CHECKER PAYPAL VALID EMAIL -->
...
<div align="center"><h2 style="color:#ffffff;">
	<a id="user-content-installation" class="anchor" href="#installation" aria-hidden="true">
<span aria-hidden="true" class="octicon octicon-link"></span></a> P0wer Ma!ler Inb0x <code style="font-size:12px;color:#0bc4d1;">v2.1 </code> </h2>
<p style="font-size:12px;color:#ffffff;"> Good Server Send Inbox Use My Script With a Good Server </p>
<div style="font-size:14px;color:#ffffff;" >
<a href="?home" class="SKANDARE-B"> Home </a> 
|| <a href="?Mister=spam" class="SKANDARE-B"> Spam Messages </a> 
|| <a href="?logout" class="SKANDARE-B"> Logout</a></div>
<? //// Info
if ($_GET['Mister'] == 'spam') { ?>
<br><br>
