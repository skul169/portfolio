...
class BestEditor {
	...
	function load_frontend_scripts() {
		...
		if ( $bootstrap === true /* or !isset($bootstrap) */ ) {
			...
			wp_enqueue_script(
				'bootstrap',
				$this->plugin_url . '/inc/bootstrap/js/bootstrap.min.js',
				array(),
				'3.3.7',
				true
			);
	...
	function tinymce_init( $init ) {
		...
		$init['templates']
		                          = "[
				{title: 'Alert Success', description: 'Insert a success alert message box', url: '" .
		                            plugins_url('plugins/template/templates/alert-success.html', __FILE__) .
		                            "'},
				{title: 'Alert Info', description: 'Insert an info alert message box', url: '" .
		                            plugins_url('plugins/template/templates/alert-info.html', __FILE__) .
		                            "'},
				{title: 'Alert Warning', description: 'Insert a warning alert message box', url: '" .
		                            plugins_url('plugins/template/templates/alert-warning.html', __FILE__) .
		                            "'},
				{title: 'Alert Danger', description: 'Insert a danger alert message box', url: '" .
		                            plugins_url('plugins/template/templates/alert-danger.html', __FILE__) .
		                            "'},
			]";
